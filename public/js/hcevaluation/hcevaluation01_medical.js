...
$(function () {
  ...
  $('#form01_addFile').click(function () {
    ...
    let row = [{
      tagName: 'tr', id: 'row' + count, childNodes: [
        ...
        { tagName: 'td', childNodes: [
          {
            tagName: 'select', name: 'form01_JobTitle[]', style: 'width:100px;', className: 'form-select form01_JobTitle', innerHTML: selectJobHTML
          },
          { tagName: 'input', type: 'text', className: 'form-control mt-1 OtherJobTitleInput', name: 'form01_1JobTitleOther[]', placeholder: '其他職稱', style: 'display:none;' }
        ] },
    ...
    $('select.form01_JobTitle').off('change').on('change', function () {
      let $this = $(this);
